## Need to quantize the model to improve performance from the Transformers library. This requires using bitsandbytes :) but
## should reduce the amount of memory we need to use and overall improve performance.
